...
- Analysing tumour microenvironment data, exploring relationships between gene expression and tissue mechanics
- Building bioinformatics tools for sequence analysis, mutation tracking, and protein translation
- Developing data-driven projects combining biology, machine learning, and real-world datasets

🤝 **I’m looking to collaborate on**
- Bioinformatics or genomics projects involving RNA-seq, variant analysis, and multi-omics
- Open-source tools that make biological data easier to analyse or visualise
- Data science projects with real-world impact

🛠️ **I’m looking for help with**
- Scaling bioinformatics pipelines using HPC, cloud workflows, and Nextflow
- Best practices for structuring production-level Python projects
- Advancing from academic analysis to research or industry-ready tools

📚 **I’m currently learning**
- Advanced bioinformatics workflows and data integration
- Neo4j and knowledge graphs for biological systems
- Machine learning applications in genomics
- Efficient data engineering and pipeline design
...
⚡ **Fun fact**
- I play multiple instruments and have developed skills in both performance and musical understanding alongside my technical work
